...
<article class="sub_pg">
    <div class="container pt-3 pb-5">
        <div class="pt-3 pb-4 mb-3 border-bottom">
            <p class="text-dark_gray fs_13 fw_300 mb-2 line_h1_2"><span class="text-primary fw_500 mr-2">[본사공지]</span> 2023.04.01 월요일</p>
            <h4 class="tit_h4 line1_text line_h1">공지사항 제목 입니다.</h4>
        </div>
        <div class="pt-3">

...
<article class="sub_pg">
    <div class="container pt-3 pb-5">
        <form action="" class="mt-3">
            ...
            <div class="form-group ip_wr mt-4 mb-3">
        ...
        <div class="cmt_wr d-flex align-items-center">
            ...
            <button type="button" class="btn btn-primary btn-block rounded-0 mt-0" onclick="location.href='./institute_album.php'">전송</button>
        </div>
    </div>
</article>
...
<script>
    $('.btn_preview').on('click',function(){
        location.href='./institute_album_preview.php';
    });
</script>
